...
crerar.attr({fill: ColorKey[dic["crerar"].val], class: "building", id: 'crerar'});
crerar.data({'info': dic['crerar']});
regions.push(crerar);
...
bj.attr({fill: ColorKey[dic["bj"].val], class: "building", id: 'bj'});
bj.data({'info': dic['bj']});
regions.push(bj);
...
southeast.attr({fill: ColorKey[dic["southeast"].val], class: "building", id: 'southeast'});
southeast.data({'info': dic['southeast']});
...
cathey.attr({fill: ColorKey[dic["cathey"].val], class: "building", id: 'cathey'});
cathey.data({'info': dic['cathey']});
regions.push(cathey);
...
south.attr({fill: ColorKey[dic["south"].val], class: "building", id: 'south'});
south.data({'info': dic['south']});
regions.push(south);
...
law.attr({fill: ColorKey[dic["law"].val], class: "building", id: 'law'});
law.data({'info': dic['law']});
regions.push(law);
...
harris.attr({fill: ColorKey[dic["harris"].val], class: "building", id: 'harris'});
harris.data({'info': dic['harris']});
regions.push(harris);

var new_grad = rsr.rect(864.167, 864.335, 77.333, 41.166);
new_grad.attr({fill: ColorKey[dic["new_grad"].val], class: "building", id: 'new_grad'});
new_grad.data({'info': dic['new_grad']});
...
ida.attr({fill: ColorKey[dic["ida"].val], class: "building", id: 'ida'});
ida.data({'info': dic['ida']});
regions.push(ida);
...
booth.attr({fill: ColorKey[dic["booth"].val], class: "building", id: 'booth'});
booth.data({'info': dic['booth']});
regions.push(booth);
...
oriental.attr({fill: ColorKey[dic["oriental"].val], class: "building", id: 'oriental'});
oriental.data({'info': dic['oriental']});
...
rock.attr({fill: ColorKey[dic["rock"].val], class: "building", id: 'rock'});
rock.data({'info': dic['rock']});
regions.push(rock);
...
quadr.attr({fill: ColorKey[dic["quadr"].val], class: "building", id: 'quadr'});
quadr.data({'info': dic['quadr']});
regions.push(quadr);
...
saieh.attr({fill: ColorKey[dic["saieh"].val], class: "building", id: 'saieh'});
saieh.data({'info': dic['saieh']});
regions.push(saieh);

var henry = rsr.rect(505, 120.335, 96, 43);
henry.attr({fill: ColorKey[dic["henry"].val], class: "building", id: 'henry'});
henry.data({'info': dic['henry']});
regions.push(henry);
...
smart.attr({fill: ColorKey[dic["smart"].val], class: "building", id: 'smart'});
smart.data({'info': dic['smart']});
regions.push(smart);

var alumni = rsr.path("M 740.5,144.835 767.5,144.835 767.5,160.335 757.5,160.335   757.5,154.835 740.5,154.835  z");
alumni.attr({fill: ColorKey[dic["alumni"].val], class: "building", id: 'alumni'});
alumni.data({'info': dic['alumni']});
regions.push(alumni);
...
snell.attr({fill: ColorKey[dic["snell"].val], class: "building", id: 'snell'});
snell.data({'info': dic['snell']});
regions.push(snell);
...
var physics = rsr.set();
physics.attr({fill: ColorKey[dic["physics"].val], class: "building", id: 'physics'});
physics.data({'info': dic['physics']});
...
physics5.attr({fill: ColorKey[dic["physics"].val], class: "building", id: 'physics'});
physics5.data({'info': dic['physics']});

var physics4 = rsr.rect(316.833, 182.602, 18, 39.899);
physics4.attr({fill: ColorKey[dic["physics"].val], class: "building", id: 'physics'});
physics4.data({'info': dic['physics']});

var physics3 = rsr.rect(282.75, 182.602, 30.5, 35.983);
physics3.attr({fill: ColorKey[dic["physics"].val], class: "building", id: 'physics'});
physics3.data({'info': dic['physics']});

var physics2 = rsr.rect(231.5, 206.835, 23.25, 31.5);
physics2.attr({fill: ColorKey[dic["physics"].val], class: "building", id: 'physics'});
physics2.data({'info': dic['physics']});
...
physics1.attr({fill: ColorKey[dic["physics"].val], class: "building", id: 'physics'});
physics1.data({'info': dic['physics']});

var med = rsr.set();
med.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med.data({'info': dic['med']});
regions.push(med);

var med6 = rsr.rect(260.5, 468.835, 35, 30.333);
med6.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med6.data({'info': dic['med']});
...
med5.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med5.data({'info': dic['med']});

var med4 = rsr.path("M 301.5,355.085 221.667,355.085 221.667,436.335 247.5,436.335 247.5,375.335    301.5,375.335   z");
med4.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med4.data({'info': dic['med']});
...
med3.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med3.data({'info': dic['med']});
...
med2.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med2.data({'info': dic['med']});
...
med1.attr({fill: ColorKey[dic["med"].val], class: "building", id: 'med'});
med1.data({'info': dic['med']});

var logan = rsr.set();
logan.attr({fill: ColorKey[dic["logan"].val], class: "building", id: 'logan'});
logan.data({'info': dic['logan']});
regions.push(logan);
...
logan2.attr({fill: ColorKey[dic["logan"].val], class: "building", id: 'logan'});
logan2.data({'info': dic['logan']});

var logan1 = rsr.path("M 245.5,872.337 223.5,872.337 223.5,899.837 214.833,899.837 214.833,907.17    245.5,907.17   z");
logan1.attr({fill: ColorKey[dic["logan"].val], class: "building", id: 'logan'});
logan1.data({'info': dic['logan']});

var eastBuild = rsr.set();
eastBuild.attr({fill: ColorKey[dic["eastBuild"].val], class: "building", id: 'eastBuild'});
eastBuild.data({'info': dic['eastBuild']});
regions.push(eastBuild);

var eastBuild4 = rsr.rect(629.25, 416.335, 23.75, 10.25);
eastBuild4.attr({fill: ColorKey[dic["eastBuild"].val], class: "building", id: 'eastBuild'});
eastBuild4.data({'info': dic['eastBuild']});
var eastBuild3 = rsr.rect(629.25, 432.585, 26.5, 8.5);
eastBuild3.attr({fill: ColorKey[dic["eastBuild"].val], class: "building", id: 'eastBuild'});
eastBuild3.data({'info': dic['eastBuild']});
var eastBuild2 = rsr.rect(629.25, 444.835, 18.25, 9);
eastBuild2.attr({fill: ColorKey[dic["eastBuild"].val], class: "building", id: 'eastBuild'});
eastBuild2.data({'info': dic['eastBuild']});
var eastBuild1 = rsr.rect(629.25, 457.085, 18.5, 8.75);
eastBuild1.attr({fill: ColorKey[dic["eastBuild"].val], class: "building", id: 'eastBuild'});
eastBuild1.data({'info': dic['eastBuild']});

var multi = rsr.set();
multi.attr({fill: ColorKey[dic["multi"].val], class: "building", id: 'multi'});
multi.data({'info': dic['multi']});
regions.push(multi);
...
multi3.attr({fill: ColorKey[dic["multi"].val], class: "building", id: 'multi'});
multi3.data({'info': dic['multi']});
...
multi2.attr({fill: ColorKey[dic["multi"].val], class: "building", id: 'multi'});
multi2.data({'info': dic['multi']});
...
multi1.attr({fill: ColorKey[dic["multi"].val], class: "building", id: 'multi'});
multi1.data({'info': dic['multi']});

var north = rsr.set();
north.attr({fill: ColorKey[dic["north"].val], class: "building", id: 'north'});
north.data({'info': dic['north']});
regions.push(north);
...
north2.attr({fill: ColorKey[dic["north"].val], class: "building", id: 'north'});
north2.data({'info': dic['north']});
...
north1.attr({fill: ColorKey[dic["north"].val], class: "building", id: 'north'});
north1.data({'info': dic['north']});

var northBuild = rsr.set();
northBuild.attr({fill: ColorKey[dic["northBuild"].val], class: "building", id: 'northBuild'});
northBuild.data({'info': dic['northBuild']});
...
northBuild2.attr({fill: ColorKey[dic["northBuild"].val], class: "building", id: 'northBuild'});
northBuild2.data({'info': dic['northBuild']});
...
northBuild1.attr({fill: ColorKey[dic["northBuild"].val], class: "building", id: 'northBuild'});
northBuild1.data({'info': dic['northBuild']});

...
mansueto.attr({fill: allObjs['mansueto'].color, class: "building", id: 'mansueto'});
mansueto.data({'info': allObjs['mansueto']});
...
regenstein.attr({fill: allObjs["regenstein"].color, class: "building", id: 'regenstein'});
regenstein.data({'info': allObjs["regenstein"]});
...
bartlett.attr({fill: allObjs["bartlett"].color, class: "building", id: 'bartlett'});
bartlett.data({'info': allObjs["bartlett"]});
...
maxp3.attr({fill: allObjs["maxp"].color, class: "building", id: 'maxp'});
maxp3.data({'info': allObjs["maxp"]});
regions.push(maxp3);

var maxp2 = rsr.rect(442.5, 181.502, 84.25, 17.083);
maxp2.attr({fill: allObjs["maxp"].color, class: "building", id: 'maxp'});
maxp2.data({'info': allObjs["maxp"]});
regions.push(maxp2);

var maxp = rsr.path("M430,181.502v17.083h-22.25v23.75H405v5.25h-7.5v-5.25h-5v-40.833H430z");
maxp.attr({fill: allObjs["maxp"].color, class: "building", id: 'maxp'});
